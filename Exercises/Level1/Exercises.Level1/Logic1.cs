...
public class Logic1
{
    ...
    {       // mēģinu īsāko koda pieraksta veidu
        ...
        int tempUpperLimit = 90;
           ...
           if (isSummer) tempUpperLimit = 100;
            // Ja tempretūra ir lielāka vai vienāda ar 60 un mazāka vai vienāda ar maksimālo vērtību,tad atgriežam patiesību(true) 
           if (temp >= 60 && temp <= tempUpperLimit) return true;
